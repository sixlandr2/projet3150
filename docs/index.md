...
La proposition de ce projet est de concevoir et de développer une application mobile visant à optimiser la communication et l'organisation entre les propriétaires et les locataires de petits immeubles résidentiels. L'approche proposée répond à la problématique identifiée en offrant un moyen plus formel et structuré pour les échanges de messages et le suivi des informations. Le tout demeurera toutefois simple et adapté aux besoins des deux parties.
...
La validation du projet sera réalisée à l'aide de scénarios d'usage représentant des situations réelles de communication entre propriétaires et locataires. Ces scénarios permettront de vérifier que les fonctionnalités développées répondent aux objectifs fixés pour le projet. Des tests fonctionnels seront effectués tout au long du développement afin de s'assurer que l'application et son système fonctionnent efficacement.

De plus, les retours obtenus lors des rencontres hebdomadaires avec le superviseur contribueront à ajuster et améliorer la solution proposée.

L'évaluation du projet reposera sur des indicateurs qualitatifs tels que la clarté de l'interface, la facilité d'utilisation et la cohérence de l'application avec la problématique initiale. Le respect des objectifs définis ainsi que du barème du cours constituera également un critère d'évaluation important.

## Équipe

Luis Andres Eche Guzman: Responsable du projet
